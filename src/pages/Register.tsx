...
import { UserPlus, ArrowRight, Loader2, Building2 } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-64px)] bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full glass-card p-8 bg-white border border-slate-200">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm">Join the {settings?.schoolName || 'Academic Portal'} today.</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-500">
          Already have an account? <Link to="/login" className="text-emerald-600 font-semibold underline-offset-4 hover:underline">Log in instead</Link>
        </p>
      </div>
    </div>
  );
